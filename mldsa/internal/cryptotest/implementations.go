...
import (
	...
	"github.com/go-webauthn/x/mldsa/internal/boring"
	"github.com/go-webauthn/x/mldsa/internal/impl"
)

// TestAllImplementations runs the provided test function with each available
// implementation of the package registered with github.com/go-webauthn/x/mldsa/internal/impl. If there
