...
//
//go:linkname fatal github.com/go-webauthn/x/mldsa/internal/fips140.fatal
func fatal(string)
...
// be added to github.com/go-webauthn/x/mldsa/internal/fips140test. If a package p calls CAST on the first
